...
using MobileCenterSample.MobileAppService.DataObjects;
using MobileCenterSample.MobileAppService.Models;
using System.Security.Claims;

namespace MobileCenterSample.MobileAppService.Controllers
{
